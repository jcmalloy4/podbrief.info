...
// Top podcasts to create directories for
const topPodcasts = [
...
// Main execution
console.log('Generating podcast directory pages...\n');
...
for (const podcast of topPodcasts) {
  console.log(`Processing: ${podcast}`);
  ...
  console.log(`  ✅ Created /podcasts/${slug}.html (${briefs.length} episodes)\n`);
  
  totalPages++;
  totalBriefs += briefs.length;
}

console.log(`\n✅ Generated ${totalPages} podcast directory pages covering ${totalBriefs} briefs`);
